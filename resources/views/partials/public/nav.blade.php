<nav class="RedesignNav" aria-label="Main navigation">
    <div class="RedesignNav-inner">
        ...
        <div class="RedesignNav-links RedesignNav-links--desktop">
            ...
            <a href="{{ route('smart_fish.page') }}#species" class="RedesignNav-link">Species</a>
            <a href="{{ route('search.page') }}" class="RedesignNav-link">Search</a>
            <a href="{{ route('smart_fish.page') }}#about" class="RedesignNav-link">About</a>
            <a href="{{ route('smart_fish.page') }}#resources" class="RedesignNav-link">Resources</a>
            <a href="{{ route('settings.edit') }}" class="RedesignNav-settings" aria-label="Settings">
